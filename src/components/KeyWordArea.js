...
function KeyWordArea({getParametryFind, payment_from, payment_to, catalogues}) {
  ...
  return (
    <div className='container-search'>
      ...
      <button data-elem="search-button" className='search-btn' onClick={(e)=>{e.stopPropagation();getParametryFind(message,payment_from,payment_to,catalogues);}}>Поиск</button>
    </div>
  );
}
